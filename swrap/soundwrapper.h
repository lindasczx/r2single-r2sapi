...
EXPORT void API GetSampleMsPosition(Handle* hSample, long* total_ms, long* current_ms);
...
EXPORT void API SetSampleMsPosition(Handle* hSample, long ms);
...
EXPORT void API GetStreamMsPosition(Handle* hStream, long* total_ms, long* current_ms);
...
EXPORT void API SetStreamMsPosition(Handle* hStream, long ms);
